                                ...
                                <div className="w-full h-64 lg:h-96 bg-gray-200 rounded-lg shadow-lg">
                                    <div className="relative w-full h-full bg-gray-50 rounded-lg flex items-center justify-center overflow-hidden">
                                        <div className="absolute inset-0 opacity-20">
                                            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] bg-repeat"></div>
                                        </div>

                                        <div className="absolute inset-0 opacity-10">
                                            <div className="absolute top-4 lg:top-6 left-4 lg:left-6 right-4 lg:right-6 h-px bg-amber-600"></div>
                                            <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 right-4 lg:right-6 h-px bg-amber-600"></div>
                                            <div className="absolute top-8 lg:top-12 left-4 lg:left-6 w-16 lg:w-20 h-px bg-amber-500"></div>
                                            <div className="absolute bottom-8 lg:bottom-12 right-4 lg:right-6 w-16 lg:w-20 h-px bg-amber-500"></div>
                                        </div>

                                        <div className="absolute top-3 lg:top-4 left-3 lg:left-4 w-4 lg:w-6 h-4 lg:h-6 border-l-2 border-t-2 border-amber-400 opacity-30"></div>
                                        <div className="absolute top-3 lg:top-4 right-3 lg:right-4 w-4 lg:w-6 h-4 lg:h-6 border-r-2 border-t-2 border-amber-400 opacity-30"></div>
                                        <div className="absolute bottom-3 lg:bottom-4 left-3 lg:left-4 w-4 lg:w-6 h-4 lg:h-6 border-l-2 border-b-2 border-amber-400 opacity-30"></div>
                                        <div className="absolute bottom-3 lg:bottom-4 right-3 lg:right-4 w-4 lg:w-6 h-4 lg:h-6 border-r-2 border-b-2 border-amber-400 opacity-30"></div>

                                        <div className="absolute inset-0 shadow-inner opacity-20"></div>

                                        <div className="relative z-10 text-center text-gray-600">
                                            <div className="w-20 h-20 lg:w-32 lg:h-32 mx-auto mb-2 lg:mb-4 flex items-center justify-center">
                                                <img
                                                    src="/Logo.svg"
                                                    alt="Cinthia Freire Logo"
                                                    className="w-20 h-20 lg:w-32 lg:h-32 object-contain drop-shadow-sm"
                                                />
                                            </div>
                                            <div className="scale-75 lg:scale-100">
                                                <img src="/Logo Cinthia.svg" alt="Logo com nome da advogada" className="drop-shadow-sm" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
